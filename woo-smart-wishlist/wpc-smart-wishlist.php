...
!defined('WOOSW_VERSION') && define('WOOSW_VERSION', '2.8.5');
		...
		if (!class_exists('WPCleverWoosw')) {
			class WPCleverWoosw
			{
				...
				function shortcode($atts)
				{
					...
					echo '<div class="product__btns"> TEST';
					echo '</div>';
					...
					<div class="wpclever_settings_page wrap">
						...
						<div class="wpclever_settings_page_desc about-text">
							<p>
								...
								<br />
								<a href="<?php echo esc_url(WOOSW_REVIEWS); ?>" target="_blank"><?php esc_html_e('Reviews', 'woo-smart-wishlist'); ?></a> | <a href="<?php echo esc_url(WOOSW_CHANGELOG); ?>" target="_blank"><?php esc_html_e('Changelog', 'woo-smart-wishlist'); ?></a>
								| <a href="<?php echo esc_url(WOOSW_DISCUSSION); ?>" target="_blank"><?php esc_html_e('Discussion', 'woo-smart-wishlist'); ?></a>
							</p>
						</div>
						<div class="wpclever_settings_page_nav">
							<h2 class="nav-tab-wrapper">
								<a href="<?php echo admin_url('admin.php?page=wpclever-woosw&tab=settings'); ?>" class="<?php echo $active_tab === 'settings' ? 'nav-tab nav-tab-active' : 'nav-tab'; ?>">
									<?php esc_html_e('Settings', 'woo-smart-wishlist'); ?>
								</a>
								<a href="<?php echo admin_url('admin.php?page=wpclever-woosw&tab=localization'); ?>" class="<?php echo $active_tab === 'localization' ? 'nav-tab nav-tab-active' : 'nav-tab'; ?>">
									<?php esc_html_e('Localization', 'woo-smart-wishlist'); ?>
								</a>
								<a href="<?php echo admin_url('admin.php?page=wpclever-woosw&tab=premium'); ?>" class="<?php echo $active_tab === 'premium' ? 'nav-tab nav-tab-active' : 'nav-tab'; ?>" style="color: #c9356e">
						...
						<div class="wpclever_settings_page_content">
								...
								<form method="post" action="options.php">
									...
									<table class="form-table">
										...
										<tr>
											...
											<td>
												<select name="woosw_disable_unauthenticated">
													<option value="yes" <?php echo (get_option('woosw_disable_unauthenticated', 'no') === 'yes' ? 'selected' : ''); ?>>
														<?php esc_html_e('Yes', 'woo-smart-wishlist'); ?>
													</option>
													<option value="no" <?php echo (get_option('woosw_disable_unauthenticated', 'no') === 'no' ? 'selected' : ''); ?>>
										...
										<tr>
											...
											<td>
												<select name="woosw_auto_remove">
													<option value="yes" <?php echo (get_option('woosw_auto_remove', 'no') === 'yes' ? 'selected' : ''); ?>>
														<?php esc_html_e('Yes', 'woo-smart-wishlist'); ?>
													</option>
													<option value="no" <?php echo (get_option('woosw_auto_remove', 'no') === 'no' ? 'selected' : ''); ?>>
														<?php esc_html_e('No', 'woo-smart-wishlist'); ?>
													</option>
												</select>
										...
										<tr>
											...
											<td>
												<select name="woosw_link">
													<option value="yes" <?php echo (get_option('woosw_link', 'yes') === 'yes' ? 'selected' : ''); ?>>
														<?php esc_html_e('Yes, open in the same tab', 'woo-smart-wishlist'); ?>
													</option>
													<option value="yes_blank" <?php echo (get_option('woosw_link', 'yes') === 'yes_blank' ? 'selected' : ''); ?>>
														<?php esc_html_e('Yes, open in the new tab', 'woo-smart-wishlist'); ?>
													</option>
													<option value="yes_popup" <?php echo (get_option('woosw_link', 'yes') === 'yes_popup' ? 'selected' : ''); ?>>
														<?php esc_html_e('Yes, open quick view popup', 'woo-smart-wishlist'); ?>
													</option>
													<option value="no" <?php echo (get_option('woosw_link', 'yes') === 'no' ? 'selected' : ''); ?>>
														<?php esc_html_e('No', 'woo-smart-wishlist'); ?>
													</option>
										...
										<tr>
											...
											<td>
												<select name="woosw_show_note">
													<option value="yes" <?php echo (get_option('woosw_show_note', 'no') === 'yes' ? 'selected' : ''); ?>>
														<?php esc_html_e('Yes', 'woo-smart-wishlist'); ?>
													</option>
													<option value="no" <?php echo (get_option('woosw_show_note', 'no') === 'no' ? 'selected' : ''); ?>>
														<?php esc_html_e('No', 'woo-smart-wishlist'); ?>
													</option>
												</select>
												...
												<p style="color: #c9356e">
													This feature is only available on the Premium Version. Click <a href="https://wpclever.net/downloads/woocommerce-smart-wishlist?utm_source=pro&utm_medium=woosw&utm_campaign=wporg" target="_blank">here</a> to buy, just $29.
												</p>
											</td>
										</tr>
										<tr class="heading">
										...
										<tr>
											...
											<td>
												<select name="woosw_page_share">
													<option value="yes" <?php echo (get_option('woosw_page_share', 'yes') === 'yes' ? 'selected' : ''); ?>>
														<?php esc_html_e('Yes', 'woo-smart-wishlist'); ?>
													</option>
													<option value="no" <?php echo (get_option('woosw_page_share', 'yes') === 'no' ? 'selected' : ''); ?>>
														<?php esc_html_e('No', 'woo-smart-wishlist'); ?>
													</option>
												</select>
												<span class="description">
										...
										<tr>
											...
											<td>
												<select name="woosw_page_icon">
													<option value="yes" <?php echo (get_option('woosw_page_icon', 'yes') === 'yes' ? 'selected' : ''); ?>>
														<?php esc_html_e('Yes', 'woo-smart-wishlist'); ?>
													</option>
													<option value="no" <?php echo (get_option('woosw_page_icon', 'yes') === 'no' ? 'selected' : ''); ?>>
														<?php esc_html_e('No', 'woo-smart-wishlist'); ?>
													</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												...
												<select multiple name="woosw_page_items[]" id='woosw_page_items'>
													<option <?php echo (in_array("facebook", $woosw_page_items)) ? "selected" : ""; ?> value="facebook"><?php esc_html_e('Facebook', 'woo-smart-wishlist'); ?>
													</option>
													<option <?php echo (in_array("twitter", $woosw_page_items)) ? "selected" : ""; ?> value="twitter"><?php esc_html_e('Twitter', 'woo-smart-wishlist'); ?>
													</option>
													<option <?php echo (in_array("pinterest", $woosw_page_items)) ? "selected" : ""; ?> value="pinterest"><?php esc_html_e('Pinterest', 'woo-smart-wishlist'); ?>
													</option>
													<option <?php echo (in_array("mail", $woosw_page_items)) ? "selected" : ""; ?> value="mail"><?php esc_html_e('Mail', 'woo-smart-wishlist'); ?>
													</option>
												</select>
											</td>
										</tr>
										<tr>
											...
											<td>
												<select name="woosw_page_copy">
													<option value="yes" <?php echo (get_option('woosw_page_copy', 'yes') === 'yes' ? 'selected' : ''); ?>>
														<?php esc_html_e('Yes', 'woo-smart-wishlist'); ?>
													</option>
													<option value="no" <?php echo (get_option('woosw_page_copy', 'yes') === 'no' ? 'selected' : ''); ?>>
														<?php esc_html_e('No', 'woo-smart-wishlist'); ?>
													</option>
												</select>
												<span class="description">
										...
										<tr>
											...
											<td>
												<select name="woosw_button_type">
													<option value="button" <?php echo (get_option('woosw_button_type', 'button') === 'button' ? 'selected' : ''); ?>>
														<?php esc_html_e('Button', 'woo-smart-wishlist'); ?>
													</option>
													<option value="link" <?php echo (get_option('woosw_button_type', 'button') === 'link' ? 'selected' : ''); ?>>
										...
										<tr>
											...
											<td>
												<select name="woosw_button_action">
													<option value="message" <?php echo (get_option('woosw_button_action', 'list') === 'message' ? 'selected' : ''); ?>>
														<?php esc_html_e('Show message', 'woo-smart-wishlist'); ?>
													</option>
													<option value="list" <?php echo (get_option('woosw_button_action', 'list') === 'list' ? 'selected' : ''); ?>>
														<?php esc_html_e('Show product list', 'woo-smart-wishlist'); ?>
													</option>
													<option value="no" <?php echo (get_option('woosw_button_action', 'list') === 'no' ? 'selected' : ''); ?>>
										...
										<tr>
											...
											<td>
												<select name="woosw_button_action_added">
													<option value="popup" <?php echo (get_option('woosw_button_action_added', 'popup') === 'popup' ? 'selected' : ''); ?>>
														<?php esc_html_e('Open wishlist popup', 'woo-smart-wishlist'); ?>
													</option>
													<option value="page" <?php echo (get_option('woosw_button_action_added', 'popup') === 'page' ? 'selected' : ''); ?>>
										...
										<tr>
											...
											<td>
												<input type="text" name="woosw_button_class" value="<?php echo get_option('woosw_button_class', ''); ?>" />
												<span class="description">
										...
										<tr>
											...
											<td>
												...
												<input type="text" name="woosw_color" value="<?php echo get_option('woosw_color', $color_default); ?>" class="woosw_color_picker" />
												<span class="description">
										...
										<tr>
											...
											<td>
												<input type="url" name="woosw_continue_url" value="<?php echo get_option('woosw_continue_url'); ?>" class="regular-text code" /> <span class="description">
										...
										<tr>
											...
											<td>
												<select name="woosw_menu_action">
													<option value="open_page" <?php echo (get_option('woosw_menu_action', 'open_page') === 'open_page' ? 'selected' : ''); ?>>
														<?php esc_html_e('Open page', 'woo-smart-wishlist'); ?>
													</option>
													<option value="open_popup" <?php echo (get_option('woosw_menu_action', 'open_page') === 'open_popup' ? 'selected' : ''); ?>>
										...
										<tr class="submit">
											<th colspan="2">
												<input type="submit" name="submit" class="button button-primary" value="<?php esc_html_e('Update Options', 'woo-smart-wishlist'); ?>" />
												<input type="hidden" name="action" value="update" />
												<input type="hidden" name="page_options" value="woosw_disable_unauthenticated,woosw_auto_remove,woosw_link,woosw_show_note,woosw_page_id,woosw_page_share,woosw_page_icon,woosw_page_items,woosw_page_copy,woosw_button_type,woosw_button_text,woosw_button_action,woosw_button_text_added,woosw_button_action_added,woosw_button_class,woosw_button_position_archive,woosw_button_position_single,woosw_cats,woosw_color,woosw_continue_url,woosw_menus,woosw_menu_action" />
											</th>
										</tr>
									</table>
								</form>
								...
								<form method="post" action="options.php">
									...
									<table class="form-table">
										...
										<tr>
											...
											<td>
												<input type="text" name="woosw_localization[button]" value="<?php echo esc_attr(self::localization('button')); ?>" placeholder="<?php esc_attr_e('Add to wishlist', 'woo-smart-wishlist'); ?>" />
											</td>
										</tr>
										<tr>
											<th><?php esc_html_e('Button text (added)', 'woo-smart-wishlist'); ?></th>
											<td>
												<input type="text" name="woosw_localization[button_added]" value="<?php echo esc_attr(self::localization('button_added')); ?>" placeholder="<?php esc_attr_e('Browse wishlist', 'woo-smart-wishlist'); ?>" />
											</td>
										</tr>
										<tr>
											<th><?php esc_html_e('Added to the wishlist message', 'woo-smart-wishlist'); ?></th>
											<td>
												<input type="text" name="woosw_localization[added_message]" value="<?php echo esc_attr(self::localization('added_message')); ?>" placeholder="<?php esc_attr_e('Added to the wishlist!', 'woo-smart-wishlist'); ?>" />
											</td>
										</tr>
										<tr>
											<th><?php esc_html_e('Already in the wishlist message', 'woo-smart-wishlist'); ?></th>
											<td>
												<input type="text" name="woosw_localization[already_message]" value="<?php echo esc_attr(self::localization('already_message')); ?>" placeholder="<?php esc_attr_e('Already in the wishlist!', 'woo-smart-wishlist'); ?>" />
											</td>
										</tr>
										<tr>
											<th><?php esc_html_e('Removed from wishlist message', 'woo-smart-wishlist'); ?></th>
											<td>
												<input type="text" name="woosw_localization[removed_message]" value="<?php echo esc_attr(self::localization('removed_message')); ?>" placeholder="<?php esc_attr_e('Removed from wishlist!', 'woo-smart-wishlist'); ?>" />
											</td>
										</tr>
										<tr>
											<th><?php esc_html_e('Empty wishlist message', 'woo-smart-wishlist'); ?></th>
											<td>
												<input type="text" name="woosw_localization[empty_message]" value="<?php echo esc_attr(self::localization('empty_message')); ?>" placeholder="<?php esc_attr_e('There are no products on the wishlist!', 'woo-smart-wishlist'); ?>" />
											</td>
										</tr>
										<tr>
											<th><?php esc_html_e('Product does not exist message', 'woo-smart-wishlist'); ?></th>
											<td>
												<input type="text" name="woosw_localization[not_exist_message]" value="<?php echo esc_attr(self::localization('not_exist_message')); ?>" placeholder="<?php esc_attr_e('The product does not exist on the wishlist!', 'woo-smart-wishlist'); ?>" />
											</td>
										</tr>
										<tr>
											<th><?php esc_html_e('Have an error message', 'woo-smart-wishlist'); ?></th>
											<td>
												<input type="text" name="woosw_localization[error_message]" value="<?php echo esc_attr(self::localization('error_message')); ?>" placeholder="<?php esc_attr_e('Have an error, please try again!', 'woo-smart-wishlist'); ?>" />
											</td>
										</tr>
										<tr>
											<th><?php esc_html_e('Need to login message', 'woo-smart-wishlist'); ?></th>
											<td>
												<input type="text" name="woosw_localization[login_message]" value="<?php echo esc_attr(self::localization('login_message')); ?>" placeholder="<?php esc_attr_e('Please log in to use the wishlist!', 'woo-smart-wishlist'); ?>" />
											</td>
										</tr>
										<tr>
											<th><?php esc_html_e('Wishlist popup heading', 'woo-smart-wishlist'); ?></th>
											<td>
												<input type="text" name="woosw_localization[popup_heading]" value="<?php echo esc_attr(self::localization('popup_heading')); ?>" placeholder="<?php esc_attr_e('Wishlist', 'woo-smart-wishlist'); ?>" />
											</td>
										</tr>
										<tr>
											<th><?php esc_html_e('Add note', 'woo-smart-wishlist'); ?></th>
											<td>
												<input type="text" name="woosw_localization[add_note]" value="<?php echo esc_attr(self::localization('add_note')); ?>" placeholder="<?php esc_attr_e('Add note', 'woo-smart-wishlist'); ?>" />
											</td>
										</tr>
										<tr>
											<th><?php esc_html_e('Save note', 'woo-smart-wishlist'); ?></th>
											<td>
												<input type="text" name="woosw_localization[save_note]" value="<?php echo esc_attr(self::localization('save_note')); ?>" placeholder="<?php esc_attr_e('Save', 'woo-smart-wishlist'); ?>" />
											</td>
										</tr>
										<tr>
											<th><?php esc_html_e('Open wishlist page', 'woo-smart-wishlist'); ?></th>
											<td>
												<input type="text" name="woosw_localization[open_page]" value="<?php echo esc_attr(self::localization('open_page')); ?>" placeholder="<?php esc_attr_e('Open wishlist page', 'woo-smart-wishlist'); ?>" />
											</td>
										</tr>
										<tr>
											<th><?php esc_html_e('Continue shopping', 'woo-smart-wishlist'); ?></th>
											<td>
												<input type="text" name="woosw_localization[continue]" value="<?php echo esc_attr(self::localization('continue')); ?>" placeholder="<?php esc_attr_e('Continue shopping', 'woo-smart-wishlist'); ?>" />
											</td>
										</tr>
										<tr>
											<th><?php esc_html_e('Wishlist menu item label', 'woo-smart-wishlist'); ?></th>
											<td>
												<input type="text" name="woosw_localization[menu_label]" value="<?php echo esc_attr(self::localization('menu_label')); ?>" placeholder="<?php esc_attr_e('Wishlist', 'woo-smart-wishlist'); ?>" />
											</td>
										</tr>
										<tr class="submit">
											<th colspan="2">
												<input type="submit" name="submit" class="button button-primary" value="<?php esc_attr_e('Update Options', 'woo-smart-wishlist'); ?>" />
												<input type="hidden" name="action" value="update" />
							...
							<?php } elseif ($active_tab === 'premium') { ?>
								<div class="wpclever_settings_page_content_text">
									<p>Get the Premium Version just $29! <a href="https://wpclever.net/downloads/woocommerce-smart-wishlist?utm_source=pro&utm_medium=woosw&utm_campaign=wporg" target="_blank">https://wpclever.net/downloads/woocommerce-smart-wishlist</a>
									</p>
				...
				function get_items($key)
				{
					...
					if (is_array($products) && (count($products) > 0)) {
						...
						foreach ($products as $product_id => $product_data) {
							...
							<tr class="woosw-content-item woosw-content-item-<?php echo esc_attr($product_id); ?>" data-id="<?php echo esc_attr($product_id); ?>" data-key="<?php echo esc_attr($key); ?>">
							...
							<div class="woosw-content">
								...
								<div class="woosw-content-bot">
									<div class="woosw-content-bot-inner">
										...
										<span class="woosw-continue" data-url="<?php echo get_option('woosw_continue_url'); ?>">
